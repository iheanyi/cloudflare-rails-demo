...
ActiveRecord::Schema[8.1].define(version: 2026_03_01_232721) do
  create_table "board_columns", force: :cascade do |t|
    ...
    t.index ["board_id", "position"], name: "index_board_columns_on_board_id_and_position"
  ...
  create_table "cards", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["board_column_id", "position"], name: "index_cards_on_board_column_id_and_position"
